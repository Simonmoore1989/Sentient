...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
  ...
  <rect x="6" y="6" width="500" height="500" rx="96" fill="none" stroke="#2ECC9A" stroke-width="8"/>
  <rect x="30" y="30" width="452" height="452" rx="80" fill="#2ECC9A" fill-opacity="0.06"/>
  <path d="M256 64L448 168V344L256 448L64 344V168L256 64Z" stroke="#2ECC9A" stroke-width="15" stroke-linejoin="round" fill="none"/>
